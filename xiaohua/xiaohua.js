...
function PKGameInitialization(init) {
	...
	window.newvote = function() {
		var Url = "/index.php?s=/PKGame/PKGameApi/newvote";
		var data = {
			sex: sex
		};
	...
	window.ranking = function() {
		var Url = "/index.php?s=/PKGame/PKGameApi/ranking";
	...
	window.vote = function(id) {
		var Url = "/index.php?s=/PKGame/PKGameApi/vote"
		var data = {
			id: id
		};
		if (typeof mugen != "undefined" && mugen == 1) data.mugen = 1;
	...
	window.report = function(data) {
		var Url = "/index.php?s=/PKGame/PKGameApi/report"
		$.ajax({
			type: "POST",
			url: Url,
			data: data,
